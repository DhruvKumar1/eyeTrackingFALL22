...
#ratio = get distance from output of Configure.py
...
#	currDistance = currPupilDist * ratio
...
while True:
	...
	pupil_pixel_dist = detectAndDisplay(frame)

	if pupil_pixel_dist != 0:
		curr_dist = 95 * 17.5 / pupil_pixel_dist

		cv.putText(frame, str(curr_dist),(50,100), cv.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 0), 2)
		if flag:
			total += curr_dist
			counter += 1
			print("Current Average:   " + str(total/counter))
